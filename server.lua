...
function payInvoice(invoice, source)
    ...
    TriggerClientEvent("Ayse_Banking:updateInvoices", source, getInvoices(activePlayersAccounts[source]))
...
function refreshInvoiceSender(invoiceId)
    ...
    for accountSource, accountNumber in pairs(activePlayersAccounts) do
        if accountNumber == invoiceSender then
            TriggerClientEvent("Ayse_Banking:updateInvoices", accountSource, getInvoices(accountNumber))
...
lib.callback.register("Ayse_Banking:actionATM", function(source, action, amount)
